                    ...
                    <div className="lg:w-1/2 lg:mx-6">
                        ...
                        <div className="mt-6 space-y-8 md:mt-8">
                            <p className="flex items-start -mx-2">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-primary dark:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <div
                            ...
                            <form className="mt-6">
                                ...
                                <div className="flex gap-6 mt-6">
                                    <div className="flex-1">
                                        <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Form Label</label>
                                ...
                                <div className="flex ">
                                    <div className="flex-1 mt-6">
                                        <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Service required*</label>
                                        {/* <input type="phone" placeholder="+91 8973924829" className="contact-form-input " /> */}
                                        <select id="Service-required" name="Service-required" data-name="Service required" className="contact-input select w-select">
                                            <option value="">Select Your Service</option>
                                            <option value="UI/UX Design">UI/UX Design</option>
                                            <option value="Mobile App Development">Mobile App Development</option>
                                            <option value="Website Development">Website Development</option>
                                            <option value="Branding &amp; Identity">Branding &amp; Identity</option>
                                            <option value="Web3 &amp; NFT Design">Web3 &amp; NFT Design</option>
                                            <option value="Full-Stack Development">Full-Stack Development</option>
                                            <option value="No-Code Development">No-Code Development</option>
                                        </select>
                                    </div>
                                    <div className="flex-1 mt-6">
                                        <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Project budget *</label>
                                        {/* <input type="phone" placeholder="+91 8973924829" className="contact-form-input " /> */}
